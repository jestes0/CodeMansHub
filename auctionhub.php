...
Purpose: Displays information about the ATP website
...
<html>
    ...
    <head>
        <!-- Imports the auctionbhub.css stylesheet. -->
            ...
            <div class="section">
                ...
                <div class=rightcol>
                    ...
                    <h4> Languages: HTML, CSS, JavaScript<br>
                        ...
                        Hosted and Database Managed by Google Firebase
                    </h4>
                    ...
                    <p>My primary duties with the project was to implement the coding for the
                        ...
                        the account would be successfully created.
                    </p>
                </div>
                <!--Buttons Link and references-->
                <div class="leftcol">
