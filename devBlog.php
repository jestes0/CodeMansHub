...
<div class="section">
  ...
  <p>Two Dev updates in a week and more to come!
    ...
    <ul>
      <li>Overhauled The navigation bar and website style</li>
      <li>Fixed the background colors to make it appealing</li>
      <li>Overhauled the Development Blog Page Format</li>
...
<div class="section">
  ...
  <p>It has been a while since I did a proper dev update, so here it is.
    ...
    <ul>
      <li>Created the CodeMan Logo</li>
      <li>Adjusted the Logo so it adjusts with navbar</li>
      <li>Adjusted main page font</li>
